...
using hostfxr_main_fn             = int32_t(HOSTFXR_CALLTYPE*)(const int argc, const char_t** argv);
using hostfxr_main_startupinfo_fn = int32_t(HOSTFXR_CALLTYPE*)(
    const int      argc,
    const char_t** argv,
    const char_t*  host_path,
    const char_t*  dotnet_root,
    const char_t*  app_path);
using hostfxr_main_bundle_startupinfo_fn = int32_t(HOSTFXR_CALLTYPE*)(
    const int      argc,
    const char_t** argv,
    const char_t*  host_path,
    const char_t*  dotnet_root,
...
//
using hostfxr_set_error_writer_fn = hostfxr_error_writer_fn(HOSTFXR_CALLTYPE*)(hostfxr_error_writer_fn error_writer);
...
//
using hostfxr_initialize_for_dotnet_command_line_fn = int32_t(HOSTFXR_CALLTYPE*)(
    int                                         argc,
    const char_t**                              argv,
...
//
using hostfxr_initialize_for_runtime_config_fn = int32_t(HOSTFXR_CALLTYPE*)(
...
//
using hostfxr_get_runtime_property_value_fn = int32_t(HOSTFXR_CALLTYPE*)(
...
//
using hostfxr_set_runtime_property_value_fn = int32_t(HOSTFXR_CALLTYPE*)(
    const hostfxr_handle host_context_handle,
    const char_t*        name,
    const char_t*        value);
...
//
using hostfxr_get_runtime_properties_fn = int32_t(HOSTFXR_CALLTYPE*)(
    const hostfxr_handle   host_context_handle,
    /*inout*/ size_t*      count,
...
//
using hostfxr_run_app_fn = int32_t(HOSTFXR_CALLTYPE*)(const hostfxr_handle host_context_handle);
...
//     hdt_get_function_pointer
//
using hostfxr_get_runtime_delegate_fn = int32_t(HOSTFXR_CALLTYPE*)(
    const hostfxr_handle       host_context_handle,
...
//     The error code result.
//
using hostfxr_close_fn = int32_t(HOSTFXR_CALLTYPE*)(const hostfxr_handle host_context_handle);
...
using hostfxr_get_dotnet_environment_info_result_fn = void(HOSTFXR_CALLTYPE*)(
