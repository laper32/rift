...
public class Tty
{
    ...
    {
        Console.Out.WriteLine($"{Chalk.Bold.Yellow["warning"]}: {message}");
    }
    ...
    {
        Console.Error.WriteLine($"{Chalk.Bold.Red["error"]}: {message}");
    }
    ...
    {
        Console.Error.WriteLine(string.IsNullOrEmpty(message)
